...
interface IHabitant {
  ...
  /**
   * It is remove all treasures from the players. It is removed when a 
   * player encounters a thief.
   * 
   */
  void removeTreasure();

  /**
   * It is used to update the strength of player. If player is hit by 
   * a monster, players strength is decreased by one.
   */
  void updateStrength();

  /**
   * It is used to get the strength of the player.
   * 
