...
interface IGridTwoD {
  ...
  /**
   * It is used to check if the adjacent location is a pit. If
   * player falls on a pit, player dies.
   * 
   ...
   * @return
   */
  boolean isAdjacentPit(int currR, int currC, int noOfRows, 
      int noOfColumns);

  /**
   * It is used to get the roaming monster at the given location in the 
   * maze.
   * 
   * @param currR current row.
   * @param currC current column.
  ...
  /**
   * It is used to get thief at the given location in the maze.
   * 
   * @param currR represents the current row.
   * @param currC represents the current column.
   * @return thief at the given location.
   */
  Thief getThief(int currR, int currC);

  /**
   * It is used to check if given location is a pit, in which 
   * case player dies.
   * 
   * @param currR represents the current row.
   * @param currC represents the current column.
   * @return true if current location is a pit.
   */
  boolean isAPit(int currR, int currC);

  /**
   * It is used to remove monster from the given location in the 
   * maze.
   * 
   * @param nCurrR represents the current row.
   * @param nCurrC represents the current column.
   */
