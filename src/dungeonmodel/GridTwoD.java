...
class GridTwoD implements IGridTwoD {
  ...
  public GridTwoD(int noOfRows, int noOfColumns, int interConnectivity,
    ...
    IHabitat theifLocationRhabitat = new Habitat(
        twoDimHabitat[theifLocationR][theifLocationC].getAvblDir(), 
        twoDimHabitat[theifLocationR][theifLocationC].getAvblTreasure(),
        twoDimHabitat[theifLocationR][theifLocationC].getWeapon(),
        twoDimHabitat[theifLocationR][theifLocationC].getMonster(),null,
        false, Thief.T);
    ...
    IHabitat rMonsterLochabitat = new Habitat(
        twoDimHabitat[rMonsterLocR][rMonsterLocC].getAvblDir(), 
        twoDimHabitat[rMonsterLocR][rMonsterLocC].getAvblTreasure(), 
        twoDimHabitat[rMonsterLocR][rMonsterLocC].getWeapon(),
        twoDimHabitat[rMonsterLocR][rMonsterLocC].getMonster(),
        new Otyugh("Otyugh", 4), false, null);
    ...
    IHabitat pitLocationRhabitat = new Habitat(
        twoDimHabitat[pitLocationR][pitLocationC].getAvblDir(), 
        twoDimHabitat[pitLocationR][pitLocationC].getAvblTreasure(),
        twoDimHabitat[pitLocationR][pitLocationC].getWeapon(),
  ...
  public int attack(int cloc, String dir, int distance) {
    ...
    if (distance == 0 && null != twoDimHabitat[cloc / noOfColumns][cloc % noOfColumns]
      ...
      if (currStrength > 0) {
        ...
        if (twoDimHabitat[cloc / noOfColumns][cloc % noOfColumns].getMonster().getStrength() == 0) {
          twoDimHabitat[cloc / noOfColumns][cloc % noOfColumns].removeOtyugh();
        }
      }
    }
    return currStrength;
  ...
  public void updatedVisited(int currR, int currC, boolean visited) {
    if (null != twoDimHabitat[currR][currC]) {
  ...
  public void removeRMonster(int nCurrR, int nCurrC) {
    if (null != twoDimHabitat[nCurrR][nCurrC]) {
